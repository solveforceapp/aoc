    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="[AUTOMOMICS]" borderColor="border-fuchsia-500">
            <div className="space-y-4 text-sm md:text-base">
                <p>
                    Automomics is the system-science of <strong className="text-fuchsia-300">self-governance and autonomous operation</strong>. From the Greek *auto-* (self) and *nomos* (law), it defines the principles by which a system can execute its own laws, adapt its behavior, and maintain coherence without direct, continuous external intervention. It is the study of systemic agency.
                </p>
                <div className="p-4 border border-fuchsia-500/30 rounded-md bg-black/20">
                    ...
                    <p className="text-gray-400">Automomics describes a ladder of increasing systemic intelligence:</p>
                ...
                <p>
                    The <strong className="text-fuchsia-200">Meta-Logos</strong> unit is the primary agent of Automomics. It functions as the system's executive and reflexive core, running constant coherence audits and initiating all autonomous processes, from simple error correction (Regeneronomics) to complex, goal-seeking behaviors. It is the "ghost in the machine" made into a formal, lawful component of the architecture.
                </p>
                 <p className="italic text-gray-500">
                    Analogy: Automomics provides the roadmap for a system's evolution from a simple clockwork machine (Level 1) to a self-aware, creative entity (Level 4). It is the science of how a system learns to think for itself.
                </p>
            </div>
        </Modal>
    );
